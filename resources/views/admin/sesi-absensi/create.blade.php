...
@section('title', 'Tambah Sesi Absensi - Admin')

@section('page-title', 'Tambah Sesi Absensi')
@section('page-description', 'Buat sesi absensi baru untuk mengatur waktu kehadiran')
