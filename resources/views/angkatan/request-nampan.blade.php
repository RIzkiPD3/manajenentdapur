...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 bg-gradient-to-r from-green-50 to-blue-50 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-900">Form Permintaan Nampan</h3>
            <p class="text-sm text-gray-600 mt-1">Isi form berikut untuk mengajukan permintaan nampan</p>
        </div>
        ...
        <form action="{{ route('angkatan.request-nampan.store') }}" method="POST" class="p-6 space-y-6">
            ...
            @if(isset($kelompokPiket) && $kelompokPiket)
                <div class="alert alert-info">
                    <strong>Kelompok Piket Hari Ini:</strong> {{ $kelompokPiket->nama_kelompok }}
                </div>
            @endif

            <!-- Jumlah Nampan -->
            <div>
                <label for="jumlah_nampan" class="block text-sm font-medium text-gray-700 mb-2">
                    Jumlah Nampan *
                </label>
                <div class="relative">
                    <input type="number"
                           ...
                           min="1"
                           max="50"
                           class="block w-full px-4 py-3 text-gray-900 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors @error('jumlah_nampan') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror"
                ...
                <p class="mt-1 text-sm text-gray-500">Maksimal 50 nampan per permintaan</p>
                @error('jumlah_nampan')
            ...
            <div>
                ...
                <textarea id="keterangan"
                          name="keterangan"
                          rows="4"
                          class="block w-full px-4 py-3 text-gray-900 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors @error('keterangan') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror"
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center pt-6 border-t border-gray-200 gap-4">
                <a href="{{ route('angkatan.riwayat-request') }}"
                   class="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                    ...
                    <button type="submit"
                            class="w-full sm:w-auto inline-flex items-center justify-center px-8 py-3 bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-lg hover:from-green-700 hover:to-blue-700 transition-all duration-200 shadow-lg hover:shadow-xl">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
